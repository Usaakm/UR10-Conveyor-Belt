...
#             # top right corner 
#             cv2.circle(image, (20, 20), 5, (0, 0, 255), -1)
#             # top left corner 
#             cv2.circle(image, (960, 20), 5, (0, 0, 255), -1)
#             # bottom left corner 
#             cv2.circle(image, (20, 730), 5, (0, 0, 255), -1)
#             # top right corner 
#             cv2.circle(image, (970, 730), 5, (0, 0, 255), -1)
...
with picamera.PiCamera() as camera:
    ...
    with picamera.array.PiRGBArray(camera, size=(Camera_Resulution_Width, Camera_Resulution_Height)) as output:
        ...
        # Detect the objects
            ...
            # contours[0]
            # Center_rect = cv2.minAreaRect(contours[0])
            # (Center_x, Center_y), (Center_w, Center_h), angle = Center_rect
            # cv2.circle(image, (int(Center_x), int(Center_y)), 5, (0, 255, ), -1)
            ...
            for cnt in filtered_contours:
                ...
                if area > Min_Contour_Area:
                    ...
                    # Center
                    cv2.circle(image, (535, 346), 5, (0, 255, 0), -1)
                    # top left corner 
                    cv2.circle(image, (72, 66), 5, (0, 255, 0), -1)
                    # top right corner
                    cv2.circle(image, (925 , 64), 5, (0, 255, 0), -1)
                    # top left corner 
                    cv2.circle(image, (79, 701), 5, (0, 255, 0), -1)
                    # bottom right corner
